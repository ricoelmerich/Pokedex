function pokemonCardTemplate(name, pic, pokemonId) {
  return `
    <div class="card" id="card-${pokemonId}" onclick="addCardOverlay(${pokemonId}, '${pic}', '${name}')">
...
function cardOverlay(pokemonId, pic, name) {
  return `
    <section id="overlay-header" class="overlay-header">
      #${pokemonId}
      <h3>${name}</h3>
    ...
    <section id="overlay-footer" class="overlay-footer">
      ...
      <div class="info-space" id="info-space"></div>
      <div class="arrows">
